...
message_attribute : isOptional='optional'? repeated='repeated'? COMMENT_OR_WS? type=EXPRESSION_NAME COMMENT_OR_WS? name=('option' | 'message' | 'syntax' | 'to' | EXPRESSION_NAME) COMMENT_OR_WS? '=' COMMENT_OR_WS? num=NUM COMMENT_OR_WS? (param_default | param_deprecated)* ';';
